...
class InlineStuffMod(loader.Module):
    ...
    strings_de = {
        ...
        "this_is_hikka": (
            "🌘 <b>Hallo! Das ist Hikka WE — mächtiger modulare Telegram Userbot. Du kannst"
    ...
    strings_tr = {
        ...
        "this_is_hikka": (
            "🌘 <b>Merhaba! Bu Hikka WE — güçlü modüler Telegram kullanıcı botu. Hesabınıza"
            " kurup, kullanabilirsiniz!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">Destek sohbeti</a></b>'
        ),
    }
    ...
    strings_hi = {
        ...
        "this_is_hikka": (
            "🌘 <b>नमस्ते! यह Hikka WE है — एक मजबूत और मॉड्यूलर टेलीग्राम यूजरबॉट। आप इसे"
            " अपने अकाउंट पर इंस्टॉल कर सकते हैं!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">सपोर्ट चैट</a></b>'
        ),
    }
    ...
    strings_uz = {
        ...
        "this_is_hikka": (
            "🌘 <b>Salom! Bu Hikka WE - kuchli modulli Telegram userboti. Siz uni"
            " o'zingizni akkauntingizga o'rnatishingiz mumkin!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">Yordam chati</a></b>'
        ),
    }
    ...
    strings_ja = {
        ...
        "this_is_hikka": (
            "🌘 <b>こんにちは！これはHikkaWEです — 力強いモジュール式のTelegramユーザーボットです。"
            "あなたはそれをあなたのアカウントにインストールすることができます！</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">サポートチャット</a></b>'
        ),
    }
    ...
    strings_kr = {
        ...
        "this_is_hikka": (
            "🌘 <b>안녕하세요! 이것은 Hikka WE입니다 — 강력하고 모듈식인 Telegram 사용자 봇입니다."
            "당신은 그것을 당신의 계정에 설치할 수 있습니다!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">지원 채팅</a></b>'
        ),
    }
    ...
    strings_ar = {
        ...
        "this_is_hikka": (
            "🌘 <b>مرحبًا! هذا هو Hikka WE - مستخدم بوت تيليغرام قوي وموديولي. يمكنك تثبيته"
            " على حسابك!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">دردشة الدعم</a></b>'
        ),
    }
    ...
    strings_es = {
        ...
        "this_is_hikka": (
            "🌘 <b>¡Hola! Este es Hikka WE - un poderoso bot de usuario modular de"
            " Telegram. ¡Puedes instalarlo en tu cuenta!</b>\n\n<b>🌍 <a"
            ' href="https://github.com/hikariaitama/Hikka">GitHub</a></b>\n<b>👥 <a'
            ' href="https://t.me/hikkawe_support">Chat de soporte</a></b>'
        ),
    }
